...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.guest_password_too_short":                 "订单密码至少 6 位",
	...
	LocaleTW: {
		...
		"error.guest_password_too_short":                 "訂單密碼至少 6 位",
	...
	LocaleEN: {
		...
		"error.guest_password_too_short":                 "Order password must be at least 6 characters",
